...
# delay of audio after midi
GLOBAL_DELAY=0.3


MAIN_PREFIX="/home/USERNAME/MW21/mw21"
COMMON_DIRECTORY="/home/USERNAME/MW21/mw21/common_files_mw21"
TERMINAL_BIN=MW21TERMINAL

# geometry
BOTTOM_SEPARATOR_HEIGHT=8

# Modeline rows calculation

FIRST_ROW_INDICATOR=$(get_config_variable "firstRow")
SECOND_ROW_INDICATOR=$(get_config_variable "secondRow")
MODELINE_ROWS_NUMBER=2
if [ ${FIRST_ROW_INDICATOR,,} == "false" ]; then
  MODELINE_ROWS_NUMBER=1
fi
if [ ${SECOND_ROW_INDICATOR,,} == "false" ]; then
  MODELINE_ROWS_NUMBER=1
fi
...
MODELINE_WIN_HEIGHT=`expr $MODELINE_ROWS_NUMBER \* $MODELINE_AREA_HEIGHT`
...
MAIN_PR_WIN_X=`expr $MODELINE_AREA_WIDTH - $PROXY_WIN_WIDTH + $DISPLAY_WIN_X`
...
# startup interval between particular applications
DEFAULT_TIMEOUT="0.5"
